...
$_POST['groupid']='Cb2503fd5c9426b9568deff6a69970789'; // PTT กนกนภา
...
if (isset($_POST["groupid"]) && isset($_POST['userid'])){
    ...
    if ($result_user->num_rows == 1) {
        ...
        $found = in_array($user_id, array_column($resultArray, 'user_id'));
        if ($found) {
